...
<head>
	<title>KAMALA INSTITUTE OF TECHNOLOGY AND SCIENCE</title>
	<!-- Meta tag Keywords -->
	...
	<style>    
.main-w3pvt-2 {
    background: url('images/h3.jpeg') no-repeat top;
}    
</style>
		...
		<header style="background-color: #060619;opacity: 0.6;filter: Alpha(opacity=50);height: 80px;">
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-lg-3 px-2">
					<!-- logo -->
					<div id="logo">
						<img src="slider/kits logo.jpeg" alt="" class="img-fluid" style="height: 60px;">
					</div>
					<!-- //logo -->
					<!-- nav -->
					<div class="nav_w3ls">
